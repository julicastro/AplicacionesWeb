...
public class EmpleadoDaoJDBC {
    ...
    private static final String SQL_SELECT_BY_ID = "SELECT id_empleado, nombre, apellido, dni, telefono, salario "
            + " FROM empleado WHERE id_empleado = ?";

    private static final String SQL_INSERT = "INSERT INTO empleado(nombre, apellido, dni, telefono, salario) "
            + " VALUES(?, ?, ?, ?, ?)";

    private static final String SQL_UPDATE = "UPDATE empleado "
            + " SET nombre=?, apellido=?, dni=?, telefono=?, salario=? WHERE id_empleado=?";
    ...
    public List<Empleado> listar() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                empleado = new Empleado(idEmpleado, nombre, apellido, dni, telefono, salario);
